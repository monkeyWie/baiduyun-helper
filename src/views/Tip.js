...
$.extend({
  tip(tip, color, time) {
    ...
    if (tipDiv.size() == 0) {
      tipDiv = $(`
      <div id="pdownTipDiv" style="position:absolute;top:74px;left:50%;z-index: 95;margin-left:-104px;padding:0 15px;background-color:${color};color:#fff;height:40px;box-shadow:0 0 4px rgba(0,0,0,.2);border-radius:4px;">
